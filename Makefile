...
# CI aliases:       make install-dev / make check

PROJECT_NAME   ?= lupaxa-photo-renamer
...
# -----------------------------------------------------------------------------
# CI / convenience aliases (reusable-python-makefile-ci defaults)
# -----------------------------------------------------------------------------

.PHONY: ensure-skills install-dev check
